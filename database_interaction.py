...
def fillItems():
    ...
    item_10 = Items(
        ...
        images      = base64.encodebytes(open(os.getcwd()+"https://github.com/BeidinaDaria/Fiction-store/blob/main/templates/styles/img/1.jpg?raw=true", mode="rb").read()).decode("utf-8"),
        color       = { '1': "blue" },
        sciense     = "Физика",
